...
<form id='form1' method="post">
  <input class="w3-input w3-section w3-border" type="text" name="nom" id="nom" placeholder="Votre Nom" value="<?php if(isset($_POST['nom'])) { echo $_POST['nom']; } ?>" /><br /><br />
  <input class="w3-input w3-section w3-border" type="text" name="prenom" id="prenom" placeholder="Votre prenom"  value="<?php if(isset($_POST['prenom'])) { echo $_POST['prenom']; } ?>" /><br /><br/>
